...
input_ReceiverPartyCode = str(sys.argv[7])
input_PrimaryPartyCode = str(sys.argv[8])
input_ThirdPartyConversationID = str(sys.argv[9])
input_TransactionReference = str(sys.argv[10])
input_PurchasedItemsDesc = str(sys.argv[11])
...
api_context.add_parameter('input_ReceiverPartyCode', input_ReceiverPartyCode)
api_context.add_parameter('input_PrimaryPartyCode', input_PrimaryPartyCode)
